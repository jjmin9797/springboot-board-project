...
import com.studio.projectboard.repository.UserAccountRepository;
...
public class ArticleService {
    ...
    public ArticleWithCommentsDto getArticle(long articleId) {
        return articleRepository.findById(articleId)
                ...
                .orElseThrow(() -> new EntityNotFoundException("해당 아이디를 찾을 수 없습니다."));
    }
    @Transactional
    ...
    public void updateArticle(ArticleDto dto) {
        try {
            ...
            log.warn("게시글 업데이트 실패 - dto : {}", dto);
        }


    }

    public void deleteArticle(ArticleDto dto) {
        articleRepository.deleteById(dto.id());
    }
